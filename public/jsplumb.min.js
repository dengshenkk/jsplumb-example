(function () {
  ...
  var e = {
    ...
    v = function (a) {
      ...
      if (t(a)) return 0;
      for (var c = r(a, 0), d = 0, e = 0, f = 1, g = null; 1 > e; )
        (e += 0.005 * f), (g = r(a, e)), (d += s(g, c)), (c = g);
  ...
  function () {
    ...
    var a = this,
      ...
      F = function (a, b, c, d) {
        ...
        var X,
          Y = function (a, b, c, d) {
            return null != P && P.constrain && "function" == typeof P.constrain
              ? P.constrain(a, b, c, d)
              : U(a, b, c, d);
          };
        ...
        var Z = function (a) {
            return "function" == typeof a
              ? ((a._katavorioId = H()), a._katavorioId)
              : a;
          },
          $ = {},
          _ = function (a) {
        ...
        (this.addSelector = function (a) {
          ...
          (this.downListener = function (a) {
            if (!a.defaultPrevented) {
              var b =
                this.rightButtonCanDrag || (3 !== a.which && 2 !== a.button);
              if (b && this.isEnabled() && this.canDrag()) {
                ...
                if (d) {
                  if (((P = null), (N = null), O.length > 0)) {
                    ...
                    if ((null != e && ((P = e[0]), (N = e[1])), null == N))
                      return;
                  } else N = this.el;
                  if (K)
                    if (
                      ((J = N.cloneNode(!0)),
                      this.params.addClass(J, r.clonedDrag),
                      J.setAttribute("id", null),
                      ...
                      (J.style.left = g[0] + "px"),
                        (J.style.top = g[1] + "px"),
                        this.params.parent.appendChild(J);
                    } else {
                      var j = f(N);
                  ...
                  G && z(a),
                    ...
                    J &&
                      J.parentNode &&
                      (F = [J.parentNode.scrollLeft, J.parentNode.scrollTop]),
          ...
          (this.moveListener = function (a) {
            if (t) {
              if (!A) {
                var b = fa("start", { el: this.el, pos: u, e: a, drag: this });
                if (b !== !1) {
                  if (!t) return;
                  this.mark(!0), (A = !0);
                } else this.abort();
              ...
              if (t) {
                ...
                J &&
                  J.parentNode &&
                  ((d += J.parentNode.scrollLeft - F[0]),
                  (e += J.parentNode.scrollTop - F[1])),
                  (d /= f),
                  (e /= f),
                  this.moveBy(d, e, a),
          ...
          (this.upListener = function (a) {
            t &&
              ...
              K
                ...
                : X &&
                  X(J, this.params.getPosition(J)) === !0 &&
                  (this.params.setPosition(J, u), fa("revert", J)));
          }.bind(this)),
        ...
        b.events.start && ea.start.push(b.events.start),
          b.events.beforeStart && ea.beforeStart.push(b.events.beforeStart),
          b.events.stop && ea.stop.push(b.events.stop),
          b.events.drag && ea.drag.push(b.events.drag),
          b.events.revert && ea.revert.push(b.events.revert),
          (this.on = function (a, b) {
            ea[a] && ea[a].push(b);
          }),
          (this.off = function (a, b) {
            if (ea[a]) {
              for (var c = [], d = 0; d < ea[a].length; d++)
                ea[a][d] !== b && c.push(ea[a][d]);
              ea[a] = c;
            }
          });
        var fa = function (a, b) {
        ...
        (this.notifyStart = function (a) {
          ...
          (this.stop = function (a, b) {
            if (b || A) {
              ...
              else c.push([J, { left: e[0], top: e[1] }, this]);
              fa("stop", {
                el: J,
                pos: ga || e,
                finalPos: e,
          ...
          (this.mark = function (a) {
            (u = this.params.getPosition(J)),
              (w = this.params.getPosition(J, !0)),
              (y = [w[0] - u[0], w[1] - u[1]]),
              (this.size = this.params.getSize(J)),
              (ca = h.getMatchingDroppables(this)),
              x(ca, !0, !1, this),
              this.params.addClass(J, this.params.dragClass || c.drag);
            var b;
            (b = this.params.getConstrainingRectangle
              ? this.params.getConstrainingRectangle(J)
              : this.params.getSize(J.parentNode)),
              (ba = { w: b[0], h: b[1] }),
              (q = 0),
              (s = 0),
        ...
        (this.unmark = function (a, d) {
          if (
            (x(ca, !1, !0, this),
            M && j(N, J)
              ? ((ga = [J.offsetLeft - q, J.offsetTop - s]),
                J.parentNode.removeChild(J),
                (J = N))
              : (ga = null),
            this.params.removeClass(J, this.params.dragClass || c.drag),
            (ca.length = 0),
            (M = !1),
            !d)
          ) {
          ...
          (this.moveBy = function (a, c, d) {
              ...
              if (e[0] !== f[0] || e[1] !== f[1]) {
                if (!M) {
                  ...
                  b.addClass(g, r.ghostProxy),
                    Q
                      ? (Q.appendChild(g),
                        (n = b.getPosition(N.parentNode, !0)),
                        (p = b.getPosition(b.ghostProxyParent, !0)),
                        (q = n[0] - p[0]),
                        (s = n[1] - p[1]))
            ...
            var h = { x: f[0], y: f[1], w: this.size[0], h: this.size[1] },
              i = { x: h.x + y[0], y: h.y + y[1], w: h.w, h: h.h },
              k = null;
            ...
            for (var l = 0; l < ca.length; l++) {
              ...
              ca[l].canDrop(this)
                ? (k || (k = ca[l].el),
                  da.push(ca[l]),
                  ca[l].setHover(this, !0, d))
                : ca[l].isHover() && ca[l].setHover(this, !1, d);
            }
            fa("drag", { el: this.el, pos: f, e: d, drag: this });
          }),
          ...
          this.params.handle
            ? aa(this.params.handle, !1)
            : aa(this.params.filter, this.params.filterExclude);
      },
      G = function (a, b, c, d) {
        ...
        return null == a
          ...
          : ((a =
              "string" == typeof a || a.constructor === String
                ? document.getElementById(a)
                : a),
            null == a ? null : ((a._katavorio = a._katavorio || H()), a));
      };
    (a.Katavorio = function (a) {
              ...
              function (b) {
                if (((b = J(b)), null != b))
                  if (null == b._katavorioDrag) {
                    var e = k(c);
                    (b._katavorioDrag = new F(b, e, m, o)),
      ...
      y(
        ...
        function (a) {
          (this[a + "Scope"] = function (b, c) {
            x(b._katavorioDrag, c, this._dragsByScope, a + "Scope"),
              x(b._katavorioDrop, c, this._dropsByScope, a + "Scope");
          }.bind(this)),
            (this[a + "DragScope"] = function (b, c) {
              x(
                b.constructor === F ? b : b._katavorioDrag,
                c,
                this._dragsByScope,
                a + "Scope"
              );
            ...
            (this[a + "DropScope"] = function (b, c) {
              x(
                b.constructor === G ? b : b._katavorioDrop,
                c,
                this._dropsByScope,
                a + "Scope"
              );
      ...
      (this.elementRemoved = function (a) {
        a._katavorioDrag && this.destroyDraggable(a),
          a._katavorioDrop && this.destroyDroppable(a);
      }),
        (this.destroyDraggable = function (a, b, c) {
          1 === arguments.length
            ? z(a, "_katavorioDrag", this._dragsByScope)
            : B(a, "_katavorioDrag", b, c);
        }),
        (this.destroyDroppable = function (a, b, c) {
          1 === arguments.length
            ? z(a, "_katavorioDrop", this._dropsByScope)
  ...
  function () {
    ...
    function B() {
      ...
      if (G.logEnabled && "undefined" != typeof console)
        try {
    ...
    var G = F.jsPlumbUtil;
    "undefined" != typeof exports && (exports.jsPlumbUtil = G),
      (G.isArray = a),
      (G.isNumber = b),
      (G.isString = c),
      (G.isBoolean = d),
      ...
      (G.functionChain = n),
      (G.populate = o),
      (G.findWithFunction = p),
      (G.removeWithFunction = q),
      (G.remove = r),
      (G.addWithFunction = s),
      (G.addToList = t),
      (G.suggest = u),
    ...
    for (var H = [], I = 0; 256 > I; I++)
      H[I] = (16 > I ? "0" : "") + I.toString(16);
    (G.uuid = w),
      (G.fastTrim = x),
      (G.each = y),
      (G.map = z),
      (G.mergeWithParents = A),
      (G.logEnabled = !0),
      (G.log = B),
      (G.wrap = C);
    var J = (function () {
    ...
    (b.jsPlumbListManager = c),
      (c.prototype = {
        addList: function (b, c) {
          ...
          this.instance.extend(e, this.options),
        ...
        for (
          ...
          if (d[i].offsetTop < b.scrollTop)
            d[i]._jsPlumbProxies ||
              ...
              a.select({ source: d[i] }).each(function (c) {
                a.proxyConnection(
                  c,
                  0,
                  b,
              ...
              a.select({ target: d[i] }).each(function (c) {
                a.proxyConnection(
                  c,
                  1,
                  b,
            ...
            d[i].offsetTop + d[i].offsetHeight >
    ...
    var a = this,
      ...
      c = function (a) {
        if (a._jsPlumb.paintStyle && a._jsPlumb.hoverPaintStyle) {
          var b = {};
          n.extend(b, a._jsPlumb.paintStyle),
            n.extend(b, a._jsPlumb.hoverPaintStyle),
    ...
    b.extend(a.jsPlumbUIComponent, b.EventGenerator, {
      ...
      addType: function (a, b, c) {
        var d = f(a),
          e = !1;
        if (null != d) {
          for (var g = 0, i = d.length; i > g; g++)
            this.hasType(d[g]) || (this._jsPlumb.types.push(d[g]), (e = !0));
          e && h(this, b, c);
        }
      },
      removeType: function (a, b, c) {
        var d = f(a),
          ...
          g = function (a) {
            ...
            return -1 !== b
              ? (j(this, b), this._jsPlumb.types.splice(b, 1), !0)
              : !1;
          }.bind(this);
        if (null != d) {
      ...
      toggleType: function (a, b, c) {
        ...
        if (null != d) {
          for (var e = 0, g = d.length; g > e; e++) {
            var i = this._jsPlumb.types.indexOf(d[e]);
            -1 !== i
              ? (j(this, i), this._jsPlumb.types.splice(i, 1))
        ...
        if (
          ...
          null != this.canvas &&
            (null != this._jsPlumb.instance.hoverClass &&
              this._jsPlumb.instance[d](
                this.canvas,
                this._jsPlumb.instance.hoverClass
              ),
            null != this._jsPlumb.hoverClass &&
              this._jsPlumb.instance[d](this.canvas, this._jsPlumb.hoverClass)),
            null != this._jsPlumb.hoverPaintStyle &&
              ...
              this._jsPlumb.instance.isSuspendDrawing() ||
                ((c = c || jsPlumbUtil.uuid()),
                this.repaint({ timestamp: c, recalc: !1 }))),
            this.getAttachedElements &&
              !b &&
              e(this, a, jsPlumbUtil.uuid(), this);
        }
      },
    });
    var k = 0,
      ...
      m = (a.jsPlumbInstance = function (c) {
        ...
        var e = this,
          ...
          k = function (a) {
            ...
            return { el: c, id: b.isString(a) && null == c ? a : S(c) };
          };
              ...
              var c = {
                ...
                f = function (a, b, d) {
                  var f = b.srcElement || b.target,
                    g =
                      (f && f.parentNode ? f.parentNode._jsPlumb : null) ||
                      (f ? f._jsPlumb : null) ||
                      (f && f.parentNode && f.parentNode.parentNode
                        ? f.parentNode.parentNode._jsPlumb
                        : null);
                  if (g) {
                    g.fire(a, g, b);
                    var h = d ? c[d + a] || a : a;
        ...
        var q = null,
          ...
          G = function (a, b, c, d) {
            ...
            if (!A && ((a = e.getElement(a)), null != a)) {
              ...
              for (
                var i =
                  (na({ elId: g, offset: b, recalc: !1, timestamp: c }), 0);
                i < h.length;
                i++
              )
                na({ elId: h[i].getAttribute("id"), recalc: !0, timestamp: c });
              var j = e.router.redraw(g, b, c, null, d);
              if (
                (Array.prototype.push.apply(f.c, j.c),
                Array.prototype.push.apply(f.e, j.e),
                h)
              )
          ...
          K = function (a, c) {
            ...
            if (
              ...
              d.source &&
                (d.source.endpoint
                  ...
                  : (d.source = e.getElement(d.source))),
              d.target &&
                (d.target.endpoint
                  ? (d.targetEndpoint = d.target)
                  : (d.target = e.getElement(d.target))),
              a.uuids &&
                ((d.sourceEndpoint = H(a.uuids[0])),
                (d.targetEndpoint = H(a.uuids[1]))),
            ...
            if (
              ...
              for (
                var f = 0, g = d.sourceEndpoint.connectorOverlays.length;
                g > f;
                f++
              )
                d.overlays.push(d.sourceEndpoint.connectorOverlays[f]);
            }
            d.sourceEndpoint &&
            ...
            return i(
              ...
              ? (d.sourceEndpoint &&
                  d.targetEndpoint &&
                  (I(d.sourceEndpoint, d.targetEndpoint) || (d = null)),
                d)
              : void 0;
          }.bind(e),
          L = function (a) {
            ...
            (a._jsPlumb = e),
              ...
              (a.newEndpoint = N),
              (a.endpointsByUUID = u),
              (a.endpointsByElement = t),
              (a.finaliseConnection = M),
              (a.id = "con_" + E());
            var c = new b(a);
            return (
              c.isDetachable() &&
          ...
          M = (e.finaliseConnection = function (a, b, c, d) {
            if (
              ((b = b || {}),
              a.suspendedEndpoint || s.push(a),
              (a.pending = null),
              (a.endpoints[0].isTemporarySource = !1),
              d !== !1 && e.router.newConnection(a),
              G(a.source),
          ...
          N = function (a, b) {
            ...
            (d._jsPlumb = e),
              ...
              (d.newEndpoint = N),
              (d.endpointsByUUID = u),
              (d.endpointsByElement = t),
              (d.fireDetachEvent = V),
              (d.elementId = b || S(d.source));
            var f = new c(d);
            return (
              (f.id = "ep_" + E()),
              ma(d.elementId, d.source),
              n.headless || e.getDragManager().endpointAdded(d.source, b),
              f
            );
          },
          O = function (a, b, c) {
        ...
        (this.setConnectionBeingDragged = function (a) {
          ...
          (this.addEndpoint = function (a, c, d) {
            ...
            var f = n.extend({}, d);
            n.extend(f, c),
              (f.endpoint = f.endpoint || e.Defaults.Endpoint),
              (f.paintStyle = f.paintStyle || e.Defaults.EndpointStyle);
            for (
              var g = [],
                h =
        ...
        var T = [
          ...
          U = function (a, b, c, d) {
            ...
            if (b.constructor === n.Endpoint)
              (e = b), e.addConnection(a), (b = e.element);
            else if (((f = S(b)), (g = this[h.epDefs][f]), f === a[h.elId]))
              e = null;
            else if (g)
              for (var l in g) {
        ...
        var V = function (a, b, c) {
            var d = e.Defaults.ConnectionType || e.getDefaultConnectionType(),
              ...
              g = f
                ...
                : a;
            b && e.fire("connectionDetached", g, c),
              e.fire("internal.connectionDetached", g, c),
              e.router.connectionDetached(g);
          },
          W = (e.fireMoveEvent = function (a, b) {
            e.fire("connectionMoved", a, b);
          });
        this.unregisterEndpoint = function (a) {
          a._jsPlumb.uuid && (u[a._jsPlumb.uuid] = null),
            e.router.deleteEndpoint(a);
          for (var b in t) {
            var c = t[b];
            if (c) {
              for (var d = [], f = 0, g = c.length; g > f; f++)
                c[f] !== a && d.push(c[f]);
              t[b] = d;
            }
        ...
        (this.deleteConnection = function (a, c) {
          return null != a &&
            ...
            ? (a.setHover(!1),
              V(a, !a.pending && c.fireEvent !== !1, c.originalEvent),
              a.endpoints[0].detachFromConnection(a),
              a.endpoints[1].detachFromConnection(a),
              b.removeWithFunction(s, function (b) {
                return a.id === b.id;
              }),
              a.cleanup(),
              a.destroy(),
          ...
          (this.deleteEveryConnection = function (a) {
            ...
            return (
              e.batch(function () {
                for (var d = 0; b > d; d++)
                  c += e.deleteConnection(s[0], a) ? 1 : 0;
              }),
              c
            );
          }),
          ...
          (this.deleteObject = function (a) {
            ...
            for (var k in c.endpoints) {
              var l = c.endpoints[k];
              l._jsPlumb &&
                (e.unregisterEndpoint(l), l.cleanup(!0), l.destroy(!0));
            }
            return c;
          });
        ...
        this.getConnections = function (a, b) {
          ...
          for (
            var c = a.scope || e.getDefaultScope(),
              d = ca(c, !0),
              f = ca(a.source),
              g = ca(a.target),
              h = !b && d.length > 1 ? {} : [],
        ...
        var ea = function (a, b) {
          ...
          ga = function (a, b) {
            var c,
              d,
              e = { length: a.length, each: ea(a, b), get: fa(a) },
              f = [
                "setHover",
                "removeAllOverlays",
                "setLabel",
        ...
        (this.select = function (a) {
          return (
            (a = a || {}),
            (a.scope = a.scope || "*"),
            ha(a.connections || e.getConnections(a, !0))
          );
        }),
          (this.selectEndpoints = function (a) {
            ...
            for (var h in t) {
              var i = da(c, h, !0),
                ...
                m = "*" !== e;
              if (i || j || l)
                a: for (var n = 0, o = t[h].length; o > n; n++) {
                  var p = t[h][n];
                  if (da(f, p.scope, !0)) {
        ...
        var ka = function (a) {
          ...
          ma = (e.manage = function (a, b, c, d) {
            return (
              v[a]
                ? d && (v[a].info = na({ elId: a, timestamp: B, recalc: !0 }))
                : ((v[a] = {
                    el: b,
                    endpoints: [],
                    connections: [],
                  ...
                  (v[a].info = na({ elId: a, timestamp: B })),
                  e.addClass(b, "jtk-managed"),
                  c ||
                    e.fire("manageElement", { id: a, info: v[a].info, el: b })),
              v[a]
            );
          });
        (this.unmanage = function (a) {
          if (v[a]) {
            var b = v[a].el;
            e.removeClass(b, "jtk-managed"),
              delete v[a],
              e.fire("unmanageElement", { id: a, el: b });
          }
        }),
          (this.rotate = function (a, b, c) {
            return v[a] &&
              ((v[a].rotation = b),
              (v[a].el.style.transform = "rotate(" + b + "deg)"),
              (v[a].el.style.transformOrigin = "center center"),
              c !== !0)
              ? this.revalidate(a)
              : { c: [], e: [] };
          }),
          ...
          return (
            ...
            !d && c && c === x[g]
              ...
              : (d || (!f && null == w[g])
                  ...
                  : ((w[g] = f || w[g]),
                    null == z[g] &&
                      ((b = v[g].el), null != b && (z[g] = e.getSize(b))),
                    (x[g] = c)),
                w[g] &&
                  !w[g].right &&
                  ((w[g].right = w[g].left + z[g][0]),
                  (w[g].bottom = w[g].top + z[g][1]),
                  (w[g].width = z[g][0]),
                  (w[g].height = z[g][1]),
                  (w[g].centerx = w[g].left + w[g].width / 2),
                  (w[g].centery = w[g].top + w[g].height / 2)),
                { o: w[g], s: z[g] })
          );
        };
        (this.updateOffset = na),
          (this.init = function () {
            r ||
              (la(),
              (e.router = new a.jsPlumb.DefaultRouter(e)),
              (e.anchorManager = e.router.anchorManager),
              (r = !0),
              e.fire("ready", e));
          }.bind(this)),
          (this.log = q),
          ...
          (this.makeAnchor = function () {
            ...
            if ("string" == typeof f)
              h = d(arguments[0], { elementId: g, jsPlumbInstance: e });
            else if (b.isArray(f))
              if (b.isArray(f[0]) || b.isString(f[0]))
                2 === f.length && b.isObject(f[1])
                  ? b.isString(f[0])
                    ? ((c = a.jsPlumb.extend(
                        { elementId: g, jsPlumbInstance: e },
                        f[1]
                      )),
                      (h = d(f[0], c)))
                    : ((c = a.jsPlumb.extend(
                        { elementId: g, jsPlumbInstance: e, anchors: f[0] },
                        f[1]
                      )),
                      (h = new a.jsPlumb.DynamicAnchor(c)))
                  : (h = new n.DynamicAnchor({
                      anchors: f,
                      selector: null,
                      elementId: g,
                      jsPlumbInstance: e,
          ...
          pa = function (c, d, f, g, h) {
            var j = new i(d),
              k = d._jsPlumb.EndpointDropHandler({
                ...
                isFull: function () {
                  var a = e.select({ target: c.id }).length;
                ...
                getEndpoint: function (b) {
                  ...
                  if (null == f || null == f._jsPlumb) {
                    var g = e.deriveEndpointAndAnchorSpec(
                        b.getType().join(" "),
                        !0
                      ),
                      h = g.endpoints
                    ...
                    g.anchors &&
                      ...
                      (f = e.addEndpoint(c.el, h)),
                      (f._mtNew = !0);
                  }
                  if (
                    (d.uniqueEndpoint && (c.def.endpoint = f),
                    f.setDeleteOnEmpty(!0),
                    b.isDetachable() && f.initDraggable(),
                    null != f.anchor.positionFinder)
                  ) {
                    var i = e.getUIPosition(arguments, e.getZoom()),
                      ...
                      l =
                        null == i
                          ? [0, 0]
                          : f.anchor.positionFinder(
                              i,
                              j,
                              k,
                              f.anchor.constructorParams
                            );
                ...
                maybeCleanup: function (a) {
                  a._mtNew && 0 === a.connections.length
                    ? e.deleteObject({ endpoint: a })
                    : delete a._mtNew;
                },
              }),
              l = a.jsPlumb.dragEvents.drop;
            return (
              (f.scope = f.scope || d.scope || e.Defaults.Scope),
              (f[l] = b.wrap(f[l], k, !0)),
              (f.rank = d.rank || 0),
              h &&
                (f[a.jsPlumb.dragEvents.over] = function () {
                  return !0;
                }),
              d.allowLoopback === !1 &&
                (f.canDrop = function (a) {
                  var b = a.getDragElement()._jsPlumbRelatedElement;
                  return b !== c.el;
                }),
              e.initDroppable(c.el, f, "internal"),
              k
            );
          };
        (this.makeTarget = function (b, c, d) {
          var f = a.jsPlumb.extend({ _jsPlumb: this }, d);
          a.jsPlumb.extend(f, c);
          for (
            var g = f.maxConnections || -1,
              h = function (b) {
                var c = k(b),
                  d = c.id,
          ...
          (this.makeSource = function (c, d, f) {
            ...
            for (
              var l = g.maxConnections || -1,
                m = g.onMaxConnections,
                n = function (d) {
                  var f = d.id,
                    i = this.getElement(d.el);
                  (this.sourceEndpointDefinitions[f] =
                    this.sourceEndpointDefinitions[f] || {}),
                    ka(f);
                  var k = {
                  ...
                  g.createEndpoint &&
                    ((k.uniqueEndpoint = !0),
                    (k.endpoint = e.addEndpoint(c, k.def)),
                    k.endpoint.setDeleteOnEmpty(!1)),
                    (this.sourceEndpointDefinitions[f][h] = k),
                    (d.def = k);
                      ...
                      if (k.enabled) {
                        if (g.filter) {
                          var n = b.isString(g.filter)
                            ? oa(c, d.el, g.filter, this, g.filterExclude)
                            : g.filter(c, d.el);
                          if (n === !1) return;
                        }
                        var o = this.select({ source: f }).length;
                        if (k.maxConnections >= 0 && o >= k.maxConnections)
                          return (
                            m && m({ element: d.el, maxConnections: l }, c), !1
                          );
                        var q = a.jsPlumb.getPositionOnElement(c, i, j),
                          r = {};
                        a.jsPlumb.extend(r, k.def),
                          (r.isTemporarySource = !0),
                          (r.anchor = [q[0], q[1], 0, 0]),
                          (r.dragOptions = p),
                          k.def.scope && (r.scope = k.def.scope),
                          (s = this.addEndpoint(f, r)),
                          (t = !0),
                          s.setDeleteOnEmpty(!0),
                          k.uniqueEndpoint &&
                            (k.endpoint
                              ? (s.finalEndpoint = k.endpoint)
                              : ((k.endpoint = s), s.setDeleteOnEmpty(!1)));
                        var u = function () {
                          e.off(s.canvas, "mouseup", u),
                            e.off(d.el, "mouseup", u),
                            t && ((t = !1), e.deleteEndpoint(s));
                        };
        ...
        (this.repaint = function (a, b, c) {
          ...
          (this.revalidate = function (a, b, c) {
            var d = c ? a : e.getId(a);
            e.updateOffset({ elId: d, recalc: !0, timestamp: b });
          ...
          (this.repaintEverything = function () {
            var a,
              b = jsPlumbUtil.uuid();
            for (a in t) e.updateOffset({ elId: a, recalc: !0, timestamp: b });
          ...
          (this.removeAllEndpoints = function (a, b, c) {
            ...
            var d = function (a) {
              var f,
                ...
                i = t[h.id];
              if (i)
                for (c.push(h), f = 0, g = i.length; g > f; f++)
                  e.deleteEndpoint(i[f], !1);
              if (
                (delete t[h.id],
                b && h.el && 3 !== h.el.nodeType && 8 !== h.el.nodeType)
              )
                for (f = 0, g = h.el.childNodes.length; g > f; f++)
                  d(h.el.childNodes[f]);
            };
            return d(a), this;
          });
        var va = function (a, b) {
          ...
          for (
            var c = e.getDragManager(),
              d = function (a) {
                c && c.elementRemoved(a.id),
                  e.router.elementRemoved(a.id),
                  e.isSource(a.el) && e.unmakeSource(a.el),
                  e.isTarget(a.el) && e.unmakeTarget(a.el),
                  e.destroyDraggable(a.el),
                  e.destroyDroppable(a.el),
                  delete e.floatingConnections[a.id],
                  delete v[a.id],
                  delete w[a.id],
                  a.el && (e.removeElement(a.el), (a.el._jsPlumb = null));
              },
              f = 1;
            f < b.length;
            f++
          ...
          (this.reset = function (a) {
            e.silently(
              function () {
                (ja = !1),
                  e.removeAllGroups(),
                  e.removeGroupManager(),
                  e.deleteEveryEndpoint(),
                  a || e.unbind(),
                  (this.targetEndpointDefinitions = {}),
                  (this.sourceEndpointDefinitions = {}),
                  (s.length = 0),
        ...
        (this.clear = function () {
          ...
          (this.deriveEndpointAndAnchorSpec = function (a, b) {
            for (
              ...
              j &&
                ...
                j.endpoint && (f = j.endpoint),
                j.anchors && (h = j.anchors),
                j.anchor && (g = j.anchor));
            }
            return { endpoints: d ? d : [f, f], anchors: h ? h : [g, g] };
          }),
          (this.setId = function (a, c, d) {
            ...
            (c = "" + c),
              ...
              (t[c] = t[e] || []);
            for (var h = 0, i = t[c].length; i > h; h++)
              t[c][h].setElementId(c), t[c][h].setReferenceElement(a);
            delete t[e],
              (this.sourceEndpointDefinitions[c] =
                this.sourceEndpointDefinitions[e]),
              delete this.sourceEndpointDefinitions[e],
              (this.targetEndpointDefinitions[c] =
                this.targetEndpointDefinitions[e]),
              delete this.targetEndpointDefinitions[e],
              this.router.changeId(e, c);
          ...
          (this.getCachedData = R),
          (this.show = function (a, b) {
            return P(a, "block", b), e;
          }),
          (this.toggleVisible = Q),
        ...
        (this.registerFloatingConnection = function (a, c, d) {
          ...
          (this.listManager = new a.jsPlumbListManager(
            this,
    ...
    b.extend(a.jsPlumbInstance, b.EventGenerator, {
      ...
      proxyConnection: function (a, b, c, d, e, f) {
        ...
        (a.proxies = a.proxies || []),
          ...
          (a.proxies[b] = { ep: g, originalEp: i }),
          0 === b
            ? this.router.sourceOrTargetChanged(h, d, a, c, 0)
            : this.router.sourceOrTargetChanged(h, d, a, c, 1),
      ...
      unproxyConnection: function (a, b, c) {
        if (null != a._jsPlumb && null != a.proxies && null != a.proxies[b]) {
          ...
          (a.endpoints[b] = a.proxies[b].originalEp),
            0 === b
              ? this.router.sourceOrTargetChanged(c, e, a, d, 0)
              : this.router.sourceOrTargetChanged(c, e, a, d, 1),
          ...
          for (c in b.overlays) {
            ...
            if (e)
              e.updateFrom(b.overlays[c][1]),
                ...
                e.reattach(a._jsPlumb.instance, a);
            else {
      ...
      this.bind("mouseover", function () {
        ...
        (this.setElement = function (d) {
          ...
          return (
            ...
            i.router.rehomeEndpoint(this, f, this.element),
              ...
              if (null == f) {
                ...
                if (c && this.anchor.isDynamic && this.connections.length > 0) {
                  ...
                  (k.index = 0 === m ? 1 : 0),
                    ...
                    (k.tRotation = i.getRotation(n));
                } else
                  this.connections.length > 0 &&
                    (k.connection = this.connections[0]);
                (k.rotation = i.getRotation(this.elementId)),
          ...
          var g,
                ...
                i.setAttribute(this.canvas, "originalScope", z),
                  ...
                  0 === y
                    ? ((o = [m.source, m.sourceId, s, z]),
                      i.router.sourceOrTargetChanged(
            ...
            z = function () {
              if ((i.setConnectionBeingDragged(!1), m && null != m.endpoints)) {
                ...
                if (
                  ((m.endpoints[0 === b ? 1 : 0].anchor.locked = !1),
              ...
              if (null != k) {
                ...
                if (
                  ...
                  var o = function (b) {
                      ...
                      if (
                        (1 === l
                          ? d.router.sourceOrTargetChanged(
                              i.floatingId,
                              i.targetId,
                              i,
                              i.target,
    ...
    (b.Connection = function (a) {
      ...
      (this.getTypeDescriptor = function () {
        ...
        (this.isDetachable = function (a) {
          return this._jsPlumb.detachable === !1
            ? !1
            : null != a
        ...
        prepareEndpoint: function (a, c, d, f, g, h, i, j, k) {
          ...
          if (f) (d.endpoints[g] = f), f.addConnection(d);
            ...
            (l = c({
              ...
              (d.endpoints[g] = l),
              h.drawEndpoints === !1 && l.setVisible(!1, !0, !0);
          }
          return l;
        },
    ...
    (c.AnchorManager = function (a) {
      var d = {},
        ...
        l = function (a, b, c, d, e, f, g, h) {
          for (
            var i = [], j = b[e ? 0 : 1] / (d.length + 1), k = 0;
            k < d.length;
            k++
          ) {
            var l = (k + 1) * j,
        ...
        o = { top: n, right: m, bottom: m, left: n },
        p = function (a, b) {
          return a.sort(b);
        },
        q = function (a, b) {
          ...
          h("bottom", d, g, b.bottom, !0, 1, [0, 1]),
            h("top", d, g, b.top, !0, 0, [0, -1]),
            h("left", d, g, b.left, !1, 0, [-1, 0]),
            h("right", d, g, b.right, !1, 1, [1, 0]);
        };
      (this.reset = function () {
        (d = {}), (g = {}), (i = {});
      }),
      ...
      (this.sourceOrTargetChanged = function (a, d, e, f, h) {
        if (0 === h) {
          if (a !== d) {
            ...
            i > -1 &&
              ((g[e.targetId][i][0] = e),
              (g[e.targetId][i][1] = e.endpoints[0]),
              (g[e.targetId][i][2] =
        ...
        (this.redraw = function (a, e, f, h, l, m) {
          ...
          if (!j.isSuspendDrawing()) {
            ...
            for (
              ...
              if (A || B) {
                ...
                var H = j.getCachedData(z),
                  I = j.getCachedData(y);
                z === y && (A || B)
                  ? (s(i[y], -Math.PI / 2, 0, x, !1, z, 0, !1, "top", y, n, o),
                    s(i[z], -Math.PI / 2, 0, x, !1, y, 1, !1, "top", z, n, o))
                  : (D ||
                      ...
                      (v[C] = D)),
                    A && s(i[y], D.theta, 0, x, !1, z, 0, !1, D.a[0], y, n, o),
                    B &&
                      s(i[z], D.theta2, -1, x, !0, y, 1, !0, D.a[1], z, n, o)),
                  A &&
                    b.addWithFunction(p, y, function (a) {
                      return a === y;
                    }),
                  B &&
                    b.addWithFunction(p, z, function (a) {
                      return a === z;
                    }),
                  ...
                  ((A && 0 === E) || (B && 1 === E)) &&
                    b.addWithFunction(o, x.endpoints[E], function (a) {
                      return a.id === x.endpoints[E].id;
                    });
              }
            }
            for (w = 0; w < r.length; w++)
              0 === r[w].connections.length &&
                r[w].anchor.isContinuous &&
                (i[a] || (i[a] = { top: [], right: [], bottom: [], left: [] }),
                s(
                  i[a],
                  -Math.PI / 2,
                  0,
                  { endpoints: [r[w], r[w]], paint: function () {} },
                  !1,
                  a,
                  0,
                  !1,
                  r[w].anchor.getDefaultFace(),
                  a,
                  n,
                  o
                ),
                b.addWithFunction(p, a, function (b) {
                  return b === a;
                }));
            ...
            for (w = 0; w < o.length; w++) {
              ...
              o[w].paint({ timestamp: null, offset: J, dimensions: J.s });
            }
            for (w = 0; w < t.length; w++) {
              var K = t[w][1];
              if (K.anchor.constructor === c.DynamicAnchor) {
                K.paint({ elementWithPrecedence: a, timestamp: f }),
                  b.addWithFunction(n, t[w][0], function (a) {
                    return a.id === t[w][0].id;
                  });
                for (var L = 0; L < K.connections.length; L++)
                  K.connections[L] !== t[w][0] &&
                    b.addWithFunction(n, K.connections[L], function (a) {
            ...
            var M = k[a];
            for (
              M && M.paint({ timestamp: f, recalc: !1, elId: a }), w = 0;
              w < n.length;
              w++
            )
              n[w].paint({
      ...
      (c.AnchorManager.prototype.calculateOrientation = function (
        ...
        if (a === b) return { orientation: j.IDENTITY, a: ["top", "top"] };
        ...
        !(function (a, b) {
          for (var c = 0; c < a.length; c++)
            if (
              ...
              for (var d in o[a[c]])
                o[a[c]][d] = jsPlumbUtil.rotatePoint(
                  o[a[c]][d],
        ...
        for (
          var r = n[0].source, s = n[0].target, t = 0;
          t < n.length &&
          ((r =
            e.isContinuous && e.locked
              ? e.getCurrentFace()
              : !e.isContinuous || e.isEdgeSupported(n[t].source)
              ? n[t].source
              : null),
          (s =
            f.isContinuous && f.locked
              ? f.getCurrentFace()
              : !f.isContinuous || f.isEdgeSupported(n[t].target)
              ? n[t].target
              : null),
          null == r || null == s);
          t++
        ...
        return (
          e.isContinuous && e.setCurrentFace(r),
          f.isContinuous && f.setCurrentFace(s),
          { a: [r, s], theta: l, theta2: m }
        );
      }),
      (c.Anchor = function (a) {
        (this.x = a.x || 0),
          ...
          (this.relocatable = a.relocatable !== !1),
          (this.snapOnRelocate = a.snapOnRelocate !== !1),
          (this.locked = !1),
          b.EventGenerator.apply(this),
          (this.compute = function (a) {
            var b = a.xy,
            ...
            var e = [
              ...
              f = a.rotation;
            if (null != f && 0 !== f) {
              var g = jsPlumbUtil.rotatePoint(
                e,
                [b[0] + c[0] / 2, b[1] + c[1] / 2],
                f
              );
              (this.orientation[0] = Math.round(
                this._unrotatedOrientation[0] * g[2] -
                  this._unrotatedOrientation[1] * g[3]
              )),
                (this.orientation[1] = Math.round(
                  this._unrotatedOrientation[1] * g[2] +
                    this._unrotatedOrientation[0] * g[3]
                )),
                (this.lastReturnValue = [g[0], g[1], this.x, this.y]);
            } else
              (this.orientation[0] = this._unrotatedOrientation[0]),
                (this.orientation[1] = this._unrotatedOrientation[1]),
                (this.lastReturnValue = e);
    ...
    (c.DynamicAnchor = function (a) {
      ...
      var e = this.anchors.length > 0 ? this.anchors[0] : null,
        ...
        g = function (a, b, c, d, e, f, g) {
          ...
          return (
            Math.sqrt(Math.pow(b - h, 2) + Math.pow(c - i, 2)) +
            Math.sqrt(Math.pow(j - h, 2) + Math.pow(k - i, 2))
          );
        },
        h =
          a.selector ||
      ...
      (this.compute = function (a) {
        ...
        return (
          ...
          this.locked || null == d || null == g
            ? ((this.lastReturnValue = e.compute(a)), this.lastReturnValue)
            : ((a.timestamp = null),
              (e = h(b, c, d, g, i, j, this.anchors)),
              (this.x = e.x),
              (this.y = e.y),
              e !== f && this.fire("anchorChanged", e),
              (f = e),
              (this.lastReturnValue = e.compute(a)),
              this.lastReturnValue)
        );
      }),
        (this.getCurrentLocation = function (a) {
            ...
            for (
              var c = b / a.length,
                ...
                e = function (a, e, f, g, h, i, j) {
                  c = b * h;
                  for (var k = (f - a) / c, l = (g - e) / c, m = 0; c > m; m++)
                    d.push([
                      a + k * m,
                      e + l * m,
                      null == i ? 0 : i,
  ...
  function () {
    ...
    b.DefaultRouter = function (a) {
      (this.jsPlumbInstance = a),
        (this.anchorManager = new b.AnchorManager({ jsPlumbInstance: a })),
  ...
  function () {
      ...
      Bezier: function (c) {
        ...
        var d = function (a) {
          ...
          f = function (a) {
            ...
            if (1 === c)
              return { x: e * d[0].x + a * d[1].x, y: e * d[0].y + a * d[1].y };
            if (4 > c) {
              var f,
                g,
                h,
        ...
        (this.pointOnPath = function (b, c) {
          return (
            (b = i(this.curve, b, c)), a.jsBezier.pointOnCurve(this.curve, b)
          );
        }),
          (this.gradientAtPoint = function (b, c) {
            return (
    ...
    (b.Connectors.AbstractConnector = function (a) {
      ...
      var r = function () {
        ...
        s = function (a, b) {
          ...
          return { segment: f[c], proportion: e, index: c };
        },
        t = function (a, c, d) {
    ...
    (g.prototype = {
      ...
      (b.Overlays.Arrow = function (a) {
        ...
        var f = a.paintStyle || { "stroke-width": 1 },
          h = a.foldback || 0.623;
  ...
  function () {
    ...
    var a = this,
      ...
      z = function (a) {
        ...
        function g(b, c) {
          for (
            var d = b.getEl().querySelectorAll(".jtk-managed"), e = 0;
            e < d.length;
            e++
          )
            a[c ? x : y](d[e], !0);
        ...
        function h(b) {
          for (var c = b.getMembers().slice(), d = [], e = 0; e < c.length; e++)
            Array.prototype.push.apply(
              d,
              c[e].querySelectorAll(".jtk-managed")
            );
          Array.prototype.push.apply(c, d);
          var f = a.getConnections({ source: c, scope: "*" }, !0),
            g = a.getConnections({ target: c, scope: "*" }, !0),
            h = {};
          ...
          var i = function (c) {
            for (var d = 0; d < c.length; d++)
              if (!h[c[d].id]) {
                ...
                e === b
                  ? (f !== b && b.connections.source.push(c[d]),
                    (j[c[d].id] = b))
                  : f === b &&
                    (b.connections.target.push(c[d]), (l[c[d].id] = b));
              }
          };
          i(f), i(g);
        }
        ...
        a.bind("connection", function (c) {
          ...
          null != d && null != e && d === e
            ? ((j[c.connection.id] = d), (l[c.connection.id] = d))
            : (null != d &&
                (b.suggest(d.connections.source, c.connection),
                (j[c.connection.id] = d)),
              null != e &&
                (b.suggest(e.connections.target, c.connection),
                (l[c.connection.id] = e)));
        }),
          a.bind(u, function (a) {
            f(a.connection);
          ...
          (this.addToGroup = function (b, c, d) {
            if ((b = this.getGroup(b))) {
              ...
              if (f !== b) {
                ...
                null != f &&
                  (f.remove(c, !1, d, !1, b), n.updateConnectionsForGroup(f)),
                  b.add(c, d);
                var i = function (a, c) {
                  var d = 0 === c ? 1 : 0;
                  a.each(function (a) {
                    a.setVisible(!1),
                      a.endpoints[d].element._jsPlumbGroup === b
                        ? (a.endpoints[d].setVisible(!1), z(a, d, b))
                        : (a.endpoints[c].setVisible(!1), s(a, c, b));
                  });
                };
                b.collapsed &&
                ...
                if (
                  ...
                  n.updateConnectionsForGroup(b),
                  a.revalidate(j),
                  !d)
                ) {
                  var l = { group: b, el: c, pos: k };
          ...
          (this.removeFromGroup = function (a, b, d) {
            if ((a = this.getGroup(a))) {
              if (a.collapsed) {
                ...
                e(a.connections.source.slice(), 0),
                  e(a.connections.target.slice(), 1);
              }
              a.remove(b, null, d);
            }
          }),
        ...
        (this.expandGroup = function (b, c) {
          ...
          (this.updateConnectionsForGroup = h),
          (this.refreshAllGroups = function () {
            for (var b in i)
              h(i[b]), a.dragManager.updateOffsets(a.getId(i[b].getEl()));
          });
      },
      A = function (c, d) {
        function e(a) {
    ...
    (c.prototype.addGroup = function (a) {
      ...
      (c.prototype.removeFromGroup = function (a, b, c) {
        this.getGroupManager().removeFromGroup(a, b, c),
          this.getContainer().appendChild(b);
      }),
      ...
      (c.prototype.getGroupFor = function (a) {
        if ((a = this.getElement(a))) {
          for (var b = this.getContainer(), c = !1, d = null, e = null; !c; )
            null == a || a === b
              ? (c = !0)
              : a[k]
              ? ((d = a[k]), (e = a), (c = !0))
  ...
  function () {
        ...
        (this.paint = function (b, d, f) {
          if (null != b) {
            ...
            null != f &&
              ...
              s(this.svg, { style: g, width: i[0] || 1, height: i[1] || 1 });
          }
        }),
        { renderer: e }
      );
    ...
    c.extend(B, [b.jsPlumbUIComponent, b.Overlays.AbstractOverlay]),
      ...
      c.extend(b.Overlays.svg.Arrow, [b.Overlays.Arrow, B], C),
      (b.Overlays.svg.PlainArrow = function () {
        B.apply(this, [b.Overlays.PlainArrow, arguments]);
      }),
      c.extend(b.Overlays.svg.PlainArrow, [b.Overlays.PlainArrow, B], C),
      (b.Overlays.svg.Diamond = function () {
        B.apply(this, [b.Overlays.Diamond, arguments]);
      }),
      c.extend(b.Overlays.svg.Diamond, [b.Overlays.Diamond, B], C),
      ...
      h = function (a) {
        ...
        return (
          ...
          c &&
            ...
            this.select({ source: a.el }).addClass(
              this.elementDraggingClass + " " + this.sourceElementDraggingClass,
              !0
            ),
            this.select({ target: a.el }).addClass(
            ...
            d = function (c) {
              ...
              null != c[1] &&
                ((b = this.getUIPosition([
                  { el: c[2].el, pos: [c[1].left, c[1].top] },
                ])),
                (d = this.draw(c[2].el, b))),
                null != c[0]._jsPlumbDragOptions &&
                  delete c[0]._jsPlumbDragOptions._dragging,
                this.removeClass(c[0], "jtk-dragged"),
                this.select({ source: c[2].el }).removeClass(
                  this.elementDraggingClass +
                    " " +
                    this.sourceElementDraggingClass,
                  !0
                ),
                this.select({ target: c[2].el }).removeClass(
                  this.elementDraggingClass +
                    " " +
                    this.targetElementDraggingClass,
                  !0
                ),
                (a.e._drawResult = a.e._drawResult || { c: [], e: [], a: [] }),
                Array.prototype.push.apply(a.e._drawResult.c, d.c),
                Array.prototype.push.apply(a.e._drawResult.e, d.e),
                Array.prototype.push.apply(a.e._drawResult.a, d.a),
                this.getDragManager().dragEnded(c[2].el);
            }.bind(this),
            e = 0;
          e < c.length;
          e++
        ...
        return (
          jsPlumb.each(
            ...
            function (a) {
              ...
              return (
                (b =
                  null == this._draggableStates[c]
                    ? !1
                    : this._draggableStates[c]),
                (b = !b),
      ...
      _initDraggableIfNecessary: function (a, b, d, e, f) {
        if (!jsPlumb.headless) {
          ...
          if (g && jsPlumb.isDragSupported(a, this)) {
            ...
            if (
              ((k = jsPlumb.extend({}, k)), jsPlumb.isAlreadyDraggable(a, this))
            )
              d.force && this.initDraggable(a, k);
            else {
              var l = jsPlumb.dragEvents.drag,
                m = jsPlumb.dragEvents.stop,
                n = jsPlumb.dragEvents.start;
              this.manage(e, a),
                (k[n] = c.wrap(k[n], h.bind(this))),
                (k[l] = c.wrap(k[l], i.bind(this))),
                (k[m] = c.wrap(k[m], j.bind(this)));
              var o = this.getId(a);
              this._draggableStates[o] = !0;
              var p = this._draggableStates[o];
              (k.disabled = null == p ? !1 : !p),
                this.initDraggable(a, k),
                this.getDragManager().register(a),
                f && this.fire("elementDraggable", { el: a, options: k });
            }
          }
        }
      },
      ...
      getElement: function (a) {
        return null == a
          ...
          : ((a =
              "string" == typeof a
                ? a
                : null == a.tagName && null != a.length && null == a.enctype
                ? a[0]
                : a),
